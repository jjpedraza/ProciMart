...
";
   ...
   <cite style='font-size:8pt;'>".Preference("RinteraDescription","","")."</cite>
    ...
    padding-right: 15px;
    ".$sombra."
    '><img src='icon/atencion.png' style='width:27px;' class='pc'><span class='pc'> ".$_SESSION['RinteraUserName']." (".$_SESSION['RinteraUser'].")</span> </td>";
    ...
    padding-right: 15px;
    ".$sombra."
    '><a href='nip.php'><img src='icon/candado.png' style='width:27px;'></a> </td>";
    ...
    <a href='logout.php'  title='sión de ".$RinteraUserName."' style=''>    
